...
import pysummarizer as pyss  # Import the library correctly

class TestPDFSummarization(unittest.TestCase):
    def setUp(self):
        """Create a valid test PDF file in F:\pysummarizer\tests"""
        self.test_pdf = os.path.abspath("F:/pysummarizer/tests/test.pdf")
        self.output_file = os.path.abspath("F:/pysummarizer/tests/summary.txt")
